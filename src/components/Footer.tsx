...
const Footer = () => {
    return (
        <footer className="footer items-center px-6 p-4 bg-neutral text-neutral-content">
            ...
            <div className="px-10 grid-flow-col gap-6 md:place-self-center md:justify-self-end">
